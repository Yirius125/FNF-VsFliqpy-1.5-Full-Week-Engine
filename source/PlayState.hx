...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (songLowercase)
		{
			...
			case 'flippy-roll':
				dialogue = CoolUtil.coolTextFile(Paths.txt('flippy-roll/dialog'));
			case 'happy-tree-land':
				dialogue = CoolUtil.coolTextFile(Paths.txt('happy-tree-land/dialog'));
			case 'massacre':
				dialogue = CoolUtil.coolTextFile(Paths.txt('massacre/dialog'));
			case 'flippin-out':
				dialogue = CoolUtil.coolTextFile(Paths.txt('flippin-out/dialog'));
			case 'unflipped-out':
				dialogue = CoolUtil.coolTextFile(Paths.txt('unflipped-out/dialog'));
		}
		...
		boyfriend = new Boyfriend(770, 450, SONG.player1, SONG.stage);
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			{
				case 0:
					FlxG.sound.play(Paths.sound('style_UI/' + SONG.ui_Style + '/' + 'intro3' + altSuffix), 0.6);
				case 1:
					...
					FlxG.sound.play(Paths.sound('style_UI/' + SONG.ui_Style + '/' + 'intro2' + altSuffix), 0.6);
				case 2:
					...
					FlxG.sound.play(Paths.sound('style_UI/' + SONG.ui_Style + '/' + 'intro1' + altSuffix), 0.6);
				case 3:
					...
					FlxG.sound.play(Paths.sound('style_UI/' + SONG.ui_Style + '/' + 'introGo' + altSuffix), 0.6);
				case 4:
			}
		...
		for (i in 0...4)
		{
			...
			switch (noteTypeCheck)
			{
				case 'pixel':
					...
					case 'normal':
						babyArrow.frames = Paths.getSparrowAtlas('style_UI/'+SONG.ui_Style+'/NOTE_assets');
